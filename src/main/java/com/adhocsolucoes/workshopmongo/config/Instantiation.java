package com.adhocsolucoes.workshopmongo.config;
...
import com.adhocsolucoes.workshopmongo.dto.AuthorDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordi feliz hoje!", new AuthorDTO(maria));
